...
public class InputBehaviourBase : MonoBehaviour
{
    // Variables
    [Header("References")]
    [SerializeField] private PlayerControllerBase m_playerController;
    [SerializeField] private RaycastBehaviourBase m_raycastBehaviour;
